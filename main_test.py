...
# -------------- Testing --------------
if IS_TEST:
    print("Demand_size(Payload): ", env.demand_size)
    payload=env.demand_size
    print("\nRestoring the model...")
...
# The name "DPRA" is used for historical reasons. Not really the case...
    ...
    with open("test_output/Data_marl_V2I.txt", "a") as f:
        f.write(str(np.average(V2I_rate_list))+', ')
    
    with open("test_output/Data_marl_V2V.txt", "a") as f:
        f.write(str(np.average(V2V_success_list))+', ')
